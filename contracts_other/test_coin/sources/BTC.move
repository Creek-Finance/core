// moved from contracts/test_coin
module test_coin::btc {
  ...
  public struct Treasury has key { id: UID, cap: TreasuryCap<BTC> }
  fun init(wtiness: BTC, ctx: &mut TxContext) {
    ...
    coin::mint_and_transfer(&mut treasuryCap, pow(10, decimals), sender, ctx);
